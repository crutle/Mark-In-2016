<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AttendanceList.aspx.cs" Inherits="FYP_MarkIn.HR.AttendanceList" %>
...
<head runat="server">
    ...
    <link href="../HRCSS/attendancelist.css" rel="stylesheet" />
    ...
    <div class="page-header1">
        ...
        <ul class="navbar">
            ...
            <div style="float:right; width:20px;"></div>
               <a id="staff" class="redirectStaffLink btn btn-default" runat="server">All Staff</a></li>
      ...
      <div class="panel-body">
        ...
        <script>
         ...
         var loadData = function () {
             ...
             userId = getParameterByName('StaffId');
             ...
             requestHandler.done(function (response) {
                 ...
                 var $cellElement;
                 var index = 0;
                 StaffId = getParameterByName('StaffId');

                 for (index = 0; index < attList.length; index++) {
                     attId = attList[index].AttendanceId;
                     $rowElement = $('<tr></tr>');
                     $cellElement = $('<td></td>', { text: StaffId });
                     $rowElement.append($cellElement);
                     $cellElement = $('<td></td>', { text: attList[index].Day });
                     $rowElement.append($cellElement);
        ...
        /////////////////////////////////////////////////////////// SEARCH ///////////////////////////////////////////////////////////
         ...
         $('.redirectStaffLink').click(function () {

             userId = getParameterByName('ID');
             console.log(userId);
             window.location.replace("Homepage.aspx?ID=" + userId);
         });
