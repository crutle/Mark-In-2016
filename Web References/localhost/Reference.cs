...
namespace FYP_MarkIn.localhost {
    using System;
    ...
    public partial class EmailWebService : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        public EmailWebService() {
            this.Url = global::FYP_MarkIn.Properties.Settings.Default.FYP_MarkIn_localhost_EmailWebService;
        ...
        /// <remarks/>
        public void SendAsync(string msgFrom, string msgTo, string msgSubject, string msgBody) {
            this.SendAsync(msgFrom, msgTo, msgSubject, msgBody, null);
        }
        
        /// <remarks/>
        public void SendAsync(string msgFrom, string msgTo, string msgSubject, string msgBody, object userState) {
            ...
            this.InvokeAsync("Send", new object[] {
                        ...
                        msgTo,
                        msgSubject,
                        msgBody}, this.SendOperationCompleted, userState);
        }
