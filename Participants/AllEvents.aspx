<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AllEvents.aspx.cs" Inherits="Mark_In_Admin.Participants.AllEvents" %>
...
<head runat="server">
    ...
    <link href="../ParticipantCSS/AllEventsCSS.css" rel="stylesheet" />
...
<body>
		...
		<div class="modal fade" id="modal-1">
	        <div class="modal-dialog">
                ...
                <div class="modal-footer">
                    ...
                    <button id="register" class="btn btn-danger ui-state-default" onclick="btnRegister_Click()">Register</button>
  ...
  <tbody>
        ...
        <script>  
          /*  $(function () {
            ...
            */
            ...
            var row, userId, selectedEventId;
       ...
       // var obj = { username: $("#txtuser").val(), name: $("#txtname").val() }; document.getElementById('SearchId')
           ...
           function joinEvent(SearchwebFormData) {
               $.ajax({
                   type: 'POST',
                   url: 'AllEvents.aspx/joinEvent',
                   data: JSON.stringify(SearchwebFormData),
                   //"{'inWebFormData':'" + webFormDataInString + "'}",
                   contentType: "application/json; charset=utf-8",
                   dataType: "json"
