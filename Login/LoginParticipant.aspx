<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LoginParticipant.aspx.cs" Inherits="Mark_In_Admin.Login.LoginParticipant" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Verify Participant</title>

    <script src="../Scripts/jquery-1.10.2.min.js"></script>
    <link href="../Content/bootstrap.min.css" rel="stylesheet" />
    <link href="../ParticipantCSS/VerifyParticipant.css" rel="stylesheet" />
...
<body>
    <form id="LoginParticipantForm" runat="server">
    <div class="container">
